/*
Copied TridentEntity class for BrokenForkEntity
*/

package org.sam.brokenforkmod.entity.custom;
...
public class BrokenForkEntity extends PersistentProjectileEntity {
    ...
    public BrokenForkEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
        super(entityType, world);
        this.tridentStack = new ItemStack(ModItems.BROKEN_FORK);
    }

    public BrokenForkEntity(World world, LivingEntity owner, ItemStack stack) {
        super(ModEntities.BROKEN_FORK, owner, world);
        this.tridentStack = new ItemStack(ModItems.BROKEN_FORK);
    ...
    static {
        LOYALTY = DataTracker.registerData(BrokenForkEntity.class, TrackedDataHandlerRegistry.BYTE);
        ENCHANTED = DataTracker.registerData(BrokenForkEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
}
